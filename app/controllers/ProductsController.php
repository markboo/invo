...
echo "into indexAction";
	...
	if ($this->request->isPost()) {
	    ...
	    $this->persistent->searchWhere = $query->getWhere();
	...
	if ($this->persistent->searchWhere)
	{
	    $where = $this->persistent->searchWhere;
	}
	...
	$builder->where($where,$parameters['bind']);
